    ...
    const handleRequestTransferCode = async (event: MouseEvent<HTMLAnchorElement>) => {
        ...
        try {
            ...
            setCodeRequestFeedback({
                type: 'success',
                message: `Support has been notified at ${supportEmail ?? 'support@obsidianwealths.com'}. Watch your email for a transfer code.`,
            });
                            ...
                            <div className="flex flex-col space-y-4">
                                ...
                                <div>
                                    <p className="text-xs text-rose-100/70">
                                        Need help? Contact us at <span className="font-semibold">{supportEmail ?? 'support@obsidianwealths.com'}</span>.
                                    </p>
                                </div>
                            </div>
                        </CardContent>
