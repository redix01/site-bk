                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-md border border-slate-700 bg-slate-800 px-3 py-2 pl-10 text-sm text-slate-50 placeholder:text-slate-500 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-slate-600"
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-md border border-slate-700 bg-slate-800 px-3 py-2 pl-10 text-sm text-slate-50 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-slate-600"
