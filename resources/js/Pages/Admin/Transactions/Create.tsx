...
export default function Create({ users }: PageProps & { users: User[] }) {
        ...
        <AdminLayout>
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-slate-50">Create Transaction</h1>
                    <p className="text-slate-400 mt-1">Add a new transaction manually</p>
                </div>
