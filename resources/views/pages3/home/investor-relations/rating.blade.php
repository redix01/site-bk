...
<!-- Mirrored from www.zkb.ch/en/home/investor-relations/rating.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jan 2026 08:05:25 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8"/>
    <title>Rating by S&amp;P, Moody&#39;s and Fitch</title>
    ...
    <meta name="description" content="Zürcher Kantonalbank has a top rating (AAA/Aaa) from the rating agencies Standard &amp; Poor&#39;s, Moody&#39;s and Fitch. Read the reasons for this best rating."/>
    <meta name="template" content="detail"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <meta name="robots" content="index,follow"/>
    

    <link rel="canonical" href="rating.html"/>
    <link rel="alternate" hreflang="en-CH" href="rating.html"/>
...
<meta property="og:url" content="rating.html"/>
<meta property="og:title" content="Rating by S&amp;P, Moody&#39;s and Fitch"/>
<meta property="og:description" content="Zürcher Kantonalbank has a top rating (AAA/Aaa) from the rating agencies Standard &amp; Poor&#39;s, Moody&#39;s and Fitch. Read the reasons for this best rating."/>
...
<meta name="twitter:title" content="Rating by S&amp;P, Moody&#39;s and Fitch"/>
<meta name="twitter:description" content="Zürcher Kantonalbank has a top rating (AAA/Aaa) from the rating agencies Standard &amp; Poor&#39;s, Moody&#39;s and Fitch. Read the reasons for this best rating."/>
    ...
    <meta name="datalayer" data-page-title="Rating" data-page-template="Detail" data-page-path="/en/home/investor-relations/rating" data-page-name="Rating | ZKBCH | /en/home/investor-relations" data-internal-domains="www.zkb.ch" data-legacy-consent-enabled="false" data-gTag-enabled="true" data-segment="English Window" data-override-report-suite="zuercherk.zkb.live" data-headline="Rating" data-language="en" data-hierarchy="English Window,Investor Relations,Rating" data-solution="ZKBCH" data-consent-enabled="true" data-country="ch" data-page-name-aem="rating"/>

    
    <script nonce="+MrfSuNDlv+g+D9SejXC760u/id2UmDrlVymUxXNYhKjTOE=">
		(function () {
...
<div class="zkb-component zkb-component--structure-title"><div class="l-max-width l-max-width--coconut">
    <h1 class="t-title t-title--page">Rating</h1>
    <p class="t-lead">We are one of the few banks in the world to have a top rating (AAA/Aaa) from Standard &amp; Poor's, Moody's and Fitch.</p>
</div>
...
<div class="dt-container">
    ...
    <h3>The key points at a glace:</h3>
<ul>
<li>Standard and Poor's (S&amp;P) rating for Zürcher Kantonalbank is AAA.</li>
<li>Moody's rating for Zürcher Kantonalbank is Aaa.</li>
<li>Fitch's rating for Zürcher Kantonalbank is AAA.</li>
</ul>
...
<div class=" l-max-width l-max-width--pineapple zkb-container zkb-container--2/3">
    ...
    <h2>Rating by Standard &amp; Poor's (S&amp;P)</h2>
<p>Since 1994, Standard &amp; Poor's has been awarding the Zürcher Kantonalbank as the only bank in Switzerland and one of the few banks worldwide with an AAA rating. This top credit rating is testimony to our excellent credit standing. This rating was reconfirmed in November 2025. It takes into account, among other considerations, the state guarantee from the canton of Zurich. But even without this factor, the "stand-alone rating" (aa-) makes the Zürcher Kantonalbank one of the safest universal banks in the world.</p>
<p>In addition, the following main factors contribute to the positive credit assessment:</p>
<ul>
<li>solid operational stability owing to a diverse business profile and strong franchise;</li>
<li>sound financial profile characterized by very strong capitalization and resilient earnings;</li>
<li>the state guarantee from the canton of Zurich, which is also assigned a AAA rating.<br>
&nbsp;</li>
</ul>
<p><a data-link-type="download-icon" href="https://www.zkb.ch/media/zkb/dokumente/investor-relations/sp_rating_zkb_november_2025.pdf" class="t-link t-link--no-highlight download-link" target="_blank"><i class="c-icon download-link__icon c-icon--m"><svg viewbox="0 0 16 16" class="c-icon__svg c-icon__svg--ui-download"><use xlink:href="#ui-download"></use></svg></i>Standard &amp; Poor's report (PDF, 229 KB)</a></p>
...
<div class="text zkb-component zkb-component--text"><div class="t-richtext l-max-width l-max-width--apple l-stack l-stack--horse l-stack--cat@phone" data-component-is="text" data-component-id="text" data-analytics-component-name="Text">
    ...
    <h2>Rating by Moody's</h2>
<p>Moody's carried out an assessment of Zürcher Kantonalbank (ZKB) for the first time in autumn 2006, and likewise assigned us their best possible rating (Aaa).</p>
<p>On 26 August 2025 Moody's confirmed the Aaa long-term deposit and issuer ratings of ZKB.</p>
<p>The affirmation of the Aaa backed long-term issuer ratings reflects ZKB's a1 BCA, three notches of rating uplift from affiliate support derived from the maintenance guarantee provided by the bank's sole owner, the Canton of Zurich, and the application of the Advanced Loss Given Failure (LGF) analysis to its liabilities, which indicates an extremely low loss given failure and results in one notch (rather than three notches) of rating uplift because of the Aaa rating ceiling.</p>
<p>ZKB's a1 BCA reflects the bank's very strong and highly resilient asset quality, despite some concentration on real estate activities in the Zurich region. Its strong capital base and solid, stable profitability. The BCA also takes into account the bank's consistently strong liquid resources.</p>
<p>&nbsp;</p>
<p><a data-link-type="download-icon" href="https://www.zkb.ch/media/zkb/dokumente/investor-relations/credit_opinion_zuercher_kantonalbank_update_26_08_2025.pdf" class="t-link t-link--no-highlight download-link" target="_blank"><i class="c-icon download-link__icon c-icon--m"><svg viewbox="0 0 16 16" class="c-icon__svg c-icon__svg--ui-download"><use xlink:href="#ui-download"></use></svg></i>Credit Opinion Moody's 26 August 2025 (PDF, 202 KB)</a></p>
<p><a data-link-type="download-icon" href="https://www.zkb.ch/media/zkb/dokumente/investor-relations/moodys_pressrelease_18sep2024.pdf" class="t-link t-link--no-highlight download-link" target="_blank"><i class="c-icon download-link__icon c-icon--m"><svg viewbox="0 0 16 16" class="c-icon__svg c-icon__svg--ui-download"><use xlink:href="#ui-download"></use></svg></i>Moody's Press Release 18 September 2024 (PDF, 52 KB)</a></p>
<p><a class="t-link t-link--no-highlight download-link" data-link-type="download-icon" href="https://www.zkb.ch/media/zkb/dokumente/en/issuer_profile_moodys_september_2022.pdf" target="_blank"><i class="c-icon download-link__icon c-icon--m"><svg viewbox="0 0 16 16" class="c-icon__svg c-icon__svg--ui-download"><use xlink:href="#ui-download"></use></svg></i>Issuer Profile Moody's (PDF, 1 MB)</a></p>
...
<div class="text zkb-component zkb-component--text"><div class="t-richtext l-max-width l-max-width--apple l-stack l-stack--horse l-stack--cat@phone" data-component-is="text" data-component-id="text" data-analytics-component-name="Text">
    ...
    <h2>Rating by Fitch</h2>
<p>In January 2009, Fitch published the first rating for Zürcher Kantonalbank.</p>
<p>In its rating report dated July 1, 2025, Fitch confirmed the bank's AAA rating with a stable outlook.</p>
<p>Key influencing factors include, in addition to the state guarantee, the leading position in deposit-taking and residential mortgage lending in the Canton of Zurich, its loan quality, strong capitalization, and adequate profitability.</p>
<p>Furthermore, ZKB has a recovery and resolution plan approved by FINMA.</p>
<p>&nbsp;</p>
<p><a href="https://www.zkb.ch/media/zkb/dokumente/investor-relations/ZKB FRR June 2025.pdf" class="t-link t-link--no-highlight download-link" data-link-type="download-icon" target="_blank"><i class="c-icon download-link__icon c-icon--m"><svg viewbox="0 0 16 16" class="c-icon__svg c-icon__svg--ui-download"><use xlink:href="#ui-download"></use></svg></i>Fitch Report July 2025 (PDF, 1 MB)</a></p>
<p><a data-link-type="download-icon" href="https://www.zkb.ch/media/zkb/dokumente/investor-relations/fitch_ratings_press_release_11_june_2025.pdf" class="t-link t-link--no-highlight download-link" target="_blank"><i class="c-icon download-link__icon c-icon--m"><svg viewbox="0 0 16 16" class="c-icon__svg c-icon__svg--ui-download"><use xlink:href="#ui-download"></use></svg></i>Fitch Ratings Press Release June 2025 (PDF, 224 KB)</a></p>
<p>&nbsp;</p>
...
<div class="text zkb-component zkb-component--text"><div class="t-richtext l-max-width l-max-width--apple l-stack l-stack--horse l-stack--cat@phone" data-component-is="text" data-component-id="text" data-analytics-component-name="Text">
    ...
    <h2>Note</h2>
<p>The rating only reflects the view of the rating agency concerned at the time of the assessment. Declarations on the significance of a rating can only be obtained from the relevant agency. Credit ratings may be amended, downgraded, temporarily suspended or withdrawn in full at any time by the rating agency if the circumstances so require in the agency's opinion.<br>
</p>
...
<div class="experiencefragment"><div class="cmp-experiencefragment cmp-experiencefragment--konzernstrategie-en ">
    ...
    <a class="t-link-area
              l-stack-none c-card c-card--style-normal c-card--bezel-normal c-card--filled-weak" data-component-is="stickybox-teaser" data-component-id="stickybox-teaser" data-analytics-campaign="corporate-oe-corporate-strategy" href="../our-company/corporate-strategy.html" data-analytics-component-name="StickyBox-Teaser">
        <h3 class="t-title t-title--card-narrow t-link-area__link">Corporate strategy</h3>
        <p class="t-paragraph">Find out how our activities fulfil our public service mandate.</p>
