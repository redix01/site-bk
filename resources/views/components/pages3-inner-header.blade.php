<div class="l-page__start" id="top">
    <header data-component-id="header" class="c-header-public c-header-public--is-zkb c-header-public--strong">
            ...
            <div class="c-header-public__topbar-scroller" data-header-topbar-scroll-container="">
                <ul class="c-header-public__topbar-left c-header-public__topbar-items c-header-public__nav-list">
                    <li class="c-header-public__topbar-list-item c-header-public__nav-list-item">
                        <a href="{{ route('pages3.home') }}" class="c-header-public__topbar-item c-header-public__item" @if(request()->routeIs('pages3.home')) aria-current="page" @endif data-component-hook-header="primary-segment-link" data-analytics-title="Home">
                ...
                <ul class="c-header-public__topbar-right c-header-public__topbar-items c-header-public__nav-list">
                    ...
                    <li class="c-header-public__nav-list-item c-header-public__topbar-list-item l-hidden@tablet l-hidden@phone ">
                        ...
                        <ul aria-hidden="true" id="item-toggle-lsd" class="c-header-public__icon-nav-submenu c-header-public__submenu">
        ...
        <div class="c-header-public__logo-burger-wrap">
            <div class="c-header__public-logo-wrap">
                <a href="{{ route('pages3.home') }}" class="c-header-public__logo" data-analytics-source="Logo">
                    <span class="t-logo-text" style="font-size: 1.8rem; font-weight: 700; color: var(--c-logo, currentColor); white-space: nowrap; font-family: sans-serif; letter-spacing: -0.5px;">{{ config('app.name') }}</span>
                </a>
            </div>
        ...
        <div class="c-header-public__mobile-wrap" id="zkb-mobile-nav">
            <ul class="c-header-public__icon-nav c-header-public__nav-list" data-analytics-source="Services">
                ...
                <li class="c-header-public__nav-list-item c-header-public__icon-nav-item l-hidden@desktop">
                    ...
                    <ul aria-hidden="true" id="item-toggle-lsm" class="c-header-public__icon-nav-submenu c-header-public__submenu">
                        <li class="c-header-public__icon-nav-submenu-item c-header-public__submenu-item">
                            <a href="#" class="c-header-public__icon-nav-item c-header-public__item c-header-public__icon-nav-item--sub-item c-header-public__item--sub-item" data-language-switch-item-language="de">
                                <span class="c-header-public__icon-nav-item-text c-header-public__item-text">De</span>
                            </a>
            ...
            <ul class="c-header-public__main-nav c-header-public__nav-list" data-component-is="navigation" data-analytics-source="Navigation" data-component-id="navigation" data-analytics-component-name="Flyout-Navigation">
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.ourcompany') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.ourcompany')) aria-current="page" @endif>Our&nbsp;Company</a>
                </li>
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.media') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.media')) aria-current="page" @endif>Media</a>
                </li>
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.investorrelations') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.investorrelations')) aria-current="page" @endif>Investor&nbsp;Relations</a>
                </li>
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.privatebanking') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.privatebanking')) aria-current="page" @endif>Private&nbsp;Banking</a>
                </li>
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.internationalbanking') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.internationalbanking')) aria-current="page" @endif>International Banking</a>
                </li>
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.institutionalclients') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.institutionalclients')) aria-current="page" @endif>Institutional&nbsp;Clients</a>
                </li>
                <li class="c-header-public__nav-list-item" data-component-id="flyout-menu">
                    <a href="{{ route('pages3.assetmanagement') }}" class="c-header-public__item c-header-public__main-nav-item" @if(request()->routeIs('pages3.assetmanagement')) aria-current="page" @endif>Asset&nbsp;Management</a>
                </li>
            </ul>
        </div>
    </header>
