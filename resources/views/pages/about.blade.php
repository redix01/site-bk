            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-8">
                    <div class="mil-banner-text mil-text-center">
                        <div class="mil-text-m mil-mb-20">About Obsidian Wealth</div>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 mil-mb-80">
                    ...
                    <p class="mil-text-m mil-soft mil-mb-60 mil-up">From our first advisory relationships to today’s broader client network, Obsidian Wealth’s purpose has remained the same: help people and businesses prosper with clarity and confidence. We invest in innovation and in people, so every interaction feels personal and every solution scales with client goals.</p>
            ...
            <div class="mil-out-frame mil-p-160-100">
                <div class="row justify-content-center mil-text-center">
                    <div class="col-xl-8 mil-mb-80-adaptive-30">
                        <h2 class="mil-up">Why Clients Trust Obsidian Wealth</h2>
                    </div>
                </div>
                <div class="row">
    ...
    <div class="mil-features mil-p-160-80">
        <div class="container">
            <div class="row flex-sm-row-reverse justify-content-between align-items-center">
                <div class="col-xl-6 mil-mb-80">
                    <h2 class="mil-mb-30 mil-up">Values That Anchor Obsidian Wealth</h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    <p class="mil-text-m mil-soft mil-mb-60">— The Obsidian Wealth Team</p>
                    <div class="row">
                        <div class="col-xl-6">
            ...
            <div class="mil-out-frame mil-p-160-160" style="background-image: url(img/home-3/5.png)">
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-7 mil-sm-text-center">
                        ...
                        <p class="mil-text-m mil-mb-60 mil-dark-soft mil-up">Partner with Obsidian Wealth and unlock tailored guidance, smarter tools, and a team committed to your long-term success.</p>
