            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-8">
                    <div class="mil-banner-text mil-text-center">
                        ...
                        <h1 class="mil-mb-60">Open an Obsidian Wealth Account</h1>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-7 mil-sm-text-center">
                        ...
                        <p class="mil-text-m mil-mb-60 mil-light mil-up">
                            Secure your spot with Obsidian Wealth and unlock digital tools, interest-earning accounts, and 24/7 account alerts.
                        </p>
