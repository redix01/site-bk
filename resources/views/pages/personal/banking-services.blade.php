            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 mil-mb-80">
                    ...
                    <p class="mil-text-m mil-soft mil-mb-30 mil-up">
                        Pick the checking experience that fits your lifestyle. From fee-free essentials to accounts that reward higher balances, Obsidian Wealth keeps your everyday money management simple and secure.
                    </p>
                    <div class="mil-up">
                        <a href="{{ route('personal.open-account') }}" class="mil-btn mil-m mil-add-arrow">Start with Obsidian Wealth</a>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mil-text-center">
                    <div class="col-xl-8 mil-mb-80-adaptive-30">
                        ...
                        <p class="mil-text-m mil-soft mil-up">
                            Obsidian Wealth clients enjoy layered security, real-time awareness, and tools that put them in control around the clock.
                        </p>
                    </div>
                </div>
                <div class="row">
