        ...
        <div class="mil-out-frame mil-out-top mil-visible">
            <div class="row flex-sm-row-reverse justify-content-between align-items-center">
                <div class="col-xl-5 mil-mb-60">
                    ...
                    <p class="mil-text-l mil-pale-2 mil-up mil-mb-60">From digital-first tools to expert support, Obsidian Wealth keeps your finances moving with clarity. Pay bills, transfer funds, and manage savings from one secure platform backed by advisors who understand long-term growth.</p>
...
<div class="icon-boxes mil-p-160-130">
    <div class="container">
        <div class="mil-text-center">
            <h2 class="mil-light mil-mb-30 mil-up">Why Clients Choose Obsidian Wealth</h2>
...
<div class="mil-dark-2 mil-p-160-130">
    <div class="container">
        <div class="mil-text-center mil-mb-60">
            ...
            <p class="mil-text-l mil-pale-2 mil-up">Open your Obsidian Wealth account with a streamlined, secure onboarding experience.</p>
        </div>
        <div class="row">
            <div class="col-xl-4 mil-mb-30">
                <div class="mil-icon-box mil-with-bg mil-dark-2 mil-center mil-up">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-xl-5 mil-mb-80">
                <h2 class="mil-light mil-mb-30 mil-up">Obsidian Wealth by the Numbers</h2>
        ...
        <div class="mil-out-frame mil-bg-2">
            <div class="row justify-content-center align-items-center mil-p-160-160">
                <div class="col-xl-7 mil-text-center">
                    ...
                    <p class="mil-text-l mil-light mil-mb-60 mil-up">Set savings goals, automate investments, and monitor cash flow with dashboards that update in real time. Wherever you are, Obsidian Wealth keeps you connected to what matters.</p>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <blockquote class="mil-center" data-swiper-parallax="-400" data-swiper-parallax-opacity="0" data-swiper-parallax-scale="0.8">
                                    ...
                                    <p class="mil-text-l mil-mb-60 mil-up mil-light">“Switching to Obsidian Wealth gave our family a single view of every account. Automatic savings boosts and real-time alerts mean we never miss a payment.”</p>
                            ...
                            <div class="swiper-slide">
                                <blockquote class="mil-center" data-swiper-parallax="-400" data-swiper-parallax-opacity="0" data-swiper-parallax-scale="0.8">
                                    ...
                                    <p class="mil-text-l mil-mb-60 mil-up mil-light">“Our treasury team relies on Obsidian Wealth for cash flow forecasting and same-day wires. The platform makes complex transactions feel effortless.”</p>
...
<footer class="mil-footer-dark-2 mil-p-160-0">
    <div class="container">
        ...
        <div class="mil-footer-bottom">
            <div class="row">
                <div class="col-xl-6">
                    <p class="mil-text-s mil-pale">© 2024 Obsidian Wealth</p>
                </div>
            </div>
        </div>
    </div>
