...
<!-- Mirrored from www.zkb.ch/en/home/international-banking/bank-guarantees.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jan 2026 08:06:18 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8"/>
    <title>Bank guarantees from Zürcher Kantonalbank</title>
    ...
    <meta name="description" content="A bank with a AAA credit rating helps you when doing business abroad."/>
    <meta name="template" content="detail"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <meta name="robots" content="index,follow"/>
    

    <link rel="canonical" href="bank-guarantees.html"/>
    <link rel="alternate" hreflang="en-CH" href="bank-guarantees.html"/>
...
<meta property="og:url" content="bank-guarantees.html"/>
<meta property="og:title" content="Bank guarantees from Zürcher Kantonalbank"/>
<meta property="og:description" content="A bank with a AAA credit rating helps you when doing business abroad."/>
...
<meta name="twitter:title" content="Bank guarantees from Zürcher Kantonalbank"/>
<meta name="twitter:description" content="A bank with a AAA credit rating helps you when doing business abroad."/>
    ...
    <meta name="datalayer" data-page-title="Bank Guarantees" data-page-template="Detail" data-page-path="/en/home/international-banking/bank-guarantees" data-page-name="Bank Guarantees | ZKBCH | /en/home/international-banking" data-internal-domains="www.zkb.ch" data-legacy-consent-enabled="false" data-gTag-enabled="true" data-segment="English Window" data-override-report-suite="zuercherk.zkb.live" data-headline="Bank Guarantees" data-language="en" data-hierarchy="English Window,International Banking,Bank Guarantees" data-solution="ZKBCH" data-consent-enabled="true" data-country="ch" data-page-name-aem="bank-guarantees"/>

    
    <script nonce="lc9Y+NAQNPW9CB83kz+r78cj2Yf6gzBDDDZbnOV96JtJBpw=">
		(function () {
...
<div class=" l-max-width l-max-width--coconut">
    ...
    <i class="c-icon c-icon--ui-arrow-navigation  c-breadcrumbs__icon c-icon--m">
        ...
        <li class="c-breadcrumbs__item">
            <a href="bank-guarantees.html" class="c-breadcrumbs__title c-breadcrumbs__title--is-current">Bank Guarantees</a>
...
<script type="application/ld+json">
  ...
  "itemListElement" : [ {
    ...
    "item" : "https://www.zkb.ch/en/home/international-banking/bank-guarantees.html"
  } ]
}
</script>
</div>
<div class="zkb-component zkb-component--structure-title"><div class="l-max-width l-max-width--coconut">
    <h1 class="t-title t-title--page">Bank Guarantees</h1>
    <p class="t-lead">Do you have to deal with business partners whom you do not know - and who in turn do not know you either? In such situations, a bank guarantee is often the ideal solution, because it proves two things to your business partners: firstly, that you are serious about business. Secondly, that a solid bank with a AAA rating will answer for your business.</p>
</div>
...
<div class="l-max-width l-max-width--coconut">
    ...
    <i class="c-icon c-icon--pikto-ranking  t-title__icon t-title__icon--large">
        <svg viewBox="0 0 16 16" class="c-icon__svg c-icon__svg--pikto-ranking">
            <use href="#pikto-ranking"></use>
                ...
                <span class="t-title__text t-title__text t-wrap-balance">Highly rated</span>
            </h3>
            <div class="l-stack l-stack--worm t-margin-reset-bottom t-wrap-balance">
                <p>Zürcher Kantonalbank is a universal bank with a AAA-rating.</p>
    ...
    <i class="c-icon c-icon--pikto-erfahren  t-title__icon t-title__icon--large">
        <svg viewBox="0 0 16 16" class="c-icon__svg c-icon__svg--pikto-erfahren">
            <use href="#pikto-erfahren"></use>
                ...
                <span class="t-title__text t-title__text t-wrap-balance">Well-advised</span>
            </h3>
            <div class="l-stack l-stack--worm t-margin-reset-bottom t-wrap-balance">
                <p>We determine the optimal form from the large variety of possibilities for you.</p>
    ...
    <i class="c-icon c-icon--pikto-einfach  t-title__icon t-title__icon--large">
        <svg viewBox="0 0 16 16" class="c-icon__svg c-icon__svg--pikto-einfach">
            ...
            <div class="l-stack l-stack--worm t-margin-reset-bottom t-wrap-balance">
                <p>Benefit from rapid handling.</p>
...
<div class="text zkb-component zkb-component--text"><div class="t-richtext l-max-width l-max-width--apple l-stack l-stack--horse l-stack--cat@phone" data-component-is="text" data-component-id="text" data-analytics-component-name="Text">
    ...
    <h2>Usage</h2>
<ul>
<li>Performance guarantees (bid-bonds, advance payment guarantees, performance bonds and warranty bonds).</li>
<li>Payment guarantees (e.g. guarantees for securing a credit facility).</li>
</ul>
...
<div class="text zkb-component zkb-component--text"><div class="t-richtext l-max-width l-max-width--apple l-stack l-stack--horse l-stack--cat@phone" data-component-is="text" data-component-id="text" data-analytics-component-name="Text">
    ...
    <h2>Overview</h2>
<ul>
<li>Supported by a AAA-rated bank.<br>
</li>
<li>Advice on optimal formulation.</li>
<li>We check foreign banks' guarantees in your favour.</li>
<li>Together with you, we determine the optimal form from the large variety of possible guarantees, surety bonds and letters of credit.</li>
<li>Comprehensive documentation, information and advice for interested parties.</li>
</ul>
